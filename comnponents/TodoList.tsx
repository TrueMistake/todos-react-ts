...
import {ListObject} from "../types/Todo";


const TodoList:FC<ListObject> = ({todos, checkedTodo, removeTodo}) => {

  return (
    <div className="todo-list">
      {todos.map((item, index) => (
        <div key={item.title + index} className={item.check ? "todo-item checked" : "todo-item"}>
          ...
          <div className="todo-item__bottom">
            ...
            >
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 315 315" enable-background="new 0 0 315 315">
                <g>
